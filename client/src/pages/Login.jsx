...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex animated-gradient" style={{ position: 'relative', overflow: 'hidden' }}>
      {/* Decorative blobs */}
      <div className="animate-float" style={{ position: 'absolute', top: '5rem', left: '5rem', width: '18rem', height: '18rem', background: 'rgba(99,102,241,0.2)', borderRadius: '9999px', filter: 'blur(48px)' }} />
      <div className="animate-float" style={{ position: 'absolute', bottom: '5rem', right: '5rem', width: '24rem', height: '24rem', background: 'rgba(129,140,248,0.1)', borderRadius: '9999px', filter: 'blur(48px)', animationDelay: '1.5s' }} />
      ...
      <div style={{ flex: 1, display: 'none', alignItems: 'center', justifyContent: 'center', padding: '3rem', position: 'relative' }} className="lg:!flex">
        <div className="animate-fade-in-up" style={{ maxWidth: '28rem' }}>
          ...
          <h1 style={{ fontSize: '2.5rem', fontWeight: 700, color: 'white', lineHeight: 1.2, marginBottom: '1rem' }}>
            ...
            work, <span style={{ color: '#a5b4fc' }}>effortlessly.</span>
          </h1>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.6)', lineHeight: 1.7 }}>
            Create projects, assign tasks, track progress — all in one beautiful workspace designed for modern teams.
          </p>
          <div style={{ marginTop: '2.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem', color: 'rgba(255,255,255,0.5)', fontSize: '0.875rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <div style={{ width: '0.5rem', height: '0.5rem', borderRadius: '9999px', background: '#4ade80' }} />
              Role-based access
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <div style={{ width: '0.5rem', height: '0.5rem', borderRadius: '9999px', background: '#60a5fa' }} />
              Real-time tracking
            </div>
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem' }}>
        <div className="auth-card animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="glass" style={{ borderRadius: '1.5rem', padding: '2.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0f172a', marginBottom: '0.5rem' }}>Welcome back</h2>
            <p style={{ color: '#64748b', marginBottom: '2rem', fontSize: '0.9375rem' }}>Sign in to your account to continue</p>
